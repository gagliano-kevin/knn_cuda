...
gpu_times1, cpu_times1 = read_execution_times('../kevin_results/artificial_trainSizes/artificial_trainSizes_csv.txt')

# Read data from the second set of files
gpu_times2, cpu_times2 = read_execution_times('../gianeh_results/artificial_trainSizes/artificial_trainSizes_csv.txt')

# Plotting  
plt.plot(range(1000, 10001, 1000), gpu_times1, label='GPU Setup 1')
plt.plot(range(1000, 10001, 1000), cpu_times1, label='CPU Setup 1')
plt.plot(range(1000, 10001, 1000), gpu_times2, label='GPU Setup 2')
plt.plot(range(1000, 10001, 1000), cpu_times2, label='CPU Setup 2')

# Adding labels and title
plt.xlabel('Training Set Size')
plt.ylabel('Execution Time (s)')
plt.title('Execution Times for Test on Training Set Size')
...
plt.savefig('trainSizes.jpg', dpi=300, bbox_inches='tight', format='jpg')
