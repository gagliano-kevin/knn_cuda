...
int main(int argc, char** argv) {
    ...
    for(num_features = 10; num_features <= 100; num_features += 10){
        ...
        appendRunStatsToFile("artificial_features_cu.txt", "artificial_features/", runTimes, 5);
        ...
        exeTimes[(num_features/10)-1] = avgKnnElaps + avgKnnDistElaps;                                          // Store the execution time for the current number of features
