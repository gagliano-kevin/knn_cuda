...
int main(int argc, char** argv) {
    ...
    //writeResultsToFile(testLabels, predictions, errorCount, testSize, "par_results_diabetes.txt", "par_results_diabetes/", trainSize, FEATURES, k, metric, exp, distDim, predDim, workers, alpha, beta, knnDistElaps, knnElaps, sharedMemorySize, maxSharedMemory, sharedWorkers); 
    ...
    exeTimeToFile("diabetes_csv.txt", "diabetes/", &exeTime, 1);
